            ...
            <div className="flex gap-4">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                        <span className="font-semibold text-secondary">⭐ {restaurant.rating}</span>
                        <span className="text-black/30">•</span>
                        <span className="text-black/60 font-medium">{restaurant.price || restaurant.priceRange}</span>
                    </div>
